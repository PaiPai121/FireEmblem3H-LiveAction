# Kostas Reference-Based Regeneration Prompt

Use case: project character asset, live-action adaptation

Official reference image, local only:

`assets/characters/antagonists/Kostas/references/official_local/legacy_ep01/fireemblemwiki_main.png`

Current generated candidate:

`assets/characters/antagonists/Kostas/selected.png`

Primary request:

Create a new photorealistic live-action adaptation of Kostas from Fire Emblem: Three Houses. Use the official reference image as the source of truth for hair shape, costume silhouette, color blocking, accessories, and faction identity. Use the current generated candidate only as a quality baseline for cinematic realism, not as the design authority.
...
- Keep age and era appropriate for the `legacy_ep01` version.
