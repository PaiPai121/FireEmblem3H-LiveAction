# Felix Reference-Based Regeneration Prompt
...
Create a new photorealistic live-action adaptation of Felix from Fire Emblem: Three Houses. Use the official reference image as the source of truth for hair shape, costume silhouette, color blocking, accessories, and faction identity. Use the current generated candidate only as a quality baseline for cinematic realism, not as the design authority.
