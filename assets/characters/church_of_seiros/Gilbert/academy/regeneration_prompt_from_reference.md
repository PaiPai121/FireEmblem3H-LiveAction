# Gilbert Reference-Based Regeneration Prompt
...
`assets/characters/church_of_seiros/Gilbert/academy/selected.png`

Primary request:

Create a new photorealistic live-action adaptation of Gilbert from Fire Emblem: Three Houses. Use the official reference image as the source of truth for hair shape, costume silhouette, color blocking, accessories, and faction identity. Use the current generated candidate only as a quality baseline for cinematic realism, not as the design authority.
