# Sothis Reference-Based Regeneration Prompt
...
`assets/characters/divine/Sothis/dream/legacy_ep01/candidate_03.png`

Primary request:

Create a new photorealistic live-action adaptation of Sothis from Fire Emblem: Three Houses. Use the official reference image as the source of truth for hair shape, costume silhouette, color blocking, accessories, and faction identity. Use the current generated candidate only as a quality baseline for cinematic realism, not as the design authority.
...
- Keep age and era appropriate for the `dream` version.
